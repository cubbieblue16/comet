...
## [2.53.0](https://github.com/cubbieblue16/comet/compare/v2.52.0...v2.53.0) (2026-04-20)


### Features

* accept tmdb: media IDs with IMDB-resolve and title fallback ([3bfb467](https://github.com/cubbieblue16/comet/commit/3bfb467190d136a27af773062944530a82c0869d))
* add date-based search queries to scrapers for date-formatted torrents ([c2318b5](https://github.com/cubbieblue16/comet/commit/c2318b58c9fb4aac6dbfc2822fa39420380b16a6))
* add DateEpisodeResolver service with cross-request TTL caching ([13ddde1](https://github.com/cubbieblue16/comet/commit/13ddde1eec55f5377a943c9797cc0c26058d00ac))
* add effective peer address resolution for WebSocket connections ([0a80dd4](https://github.com/cubbieblue16/comet/commit/0a80dd4092e6e1e4d714da613e609148a1abd01e))
* add extract_date_from_title utility for date-based torrent names ([2db1961](https://github.com/cubbieblue16/comet/commit/2db1961c725c39625ae55dd2039527c8c7e81175))
* add live preview for result format selection in the UI ([5394a40](https://github.com/cubbieblue16/comet/commit/5394a40777d864b281c0ec112ca3989038e66e7f))
* add live preview for result format selection in the UI ([8d5ef18](https://github.com/cubbieblue16/comet/commit/8d5ef18843947a49e003add3f142c09a27eba4e9))
* add manual scrape queue from admin portal, hide sync button ([4706f07](https://github.com/cubbieblue16/comet/commit/4706f07f825be45fa146b123f6a9f54184114477))
* add memory management features to optimize resource usage ([76ccb4d](https://github.com/cubbieblue16/comet/commit/76ccb4d690670745096bf67720db0537e9687880))
* add series episode index refresh functionality ([f028b22](https://github.com/cubbieblue16/comet/commit/f028b2209e0e8b0a4eb33d823ce2780e40f9438d))
* add series episode index refresh table to migration schema ([ac232f5](https://github.com/cubbieblue16/comet/commit/ac232f5fca9cb123b3ec7d7d3688fd8029632c0d))
* add TMDB season episode lookup and season listing methods ([d9d5a73](https://github.com/cubbieblue16/comet/commit/d9d5a733f03761bce558316510ce49e26f4737b0))
* auto scrape debrid account library with "Library" tag ([005523c](https://github.com/cubbieblue16/comet/commit/005523c79e7ef3b3a897104d274ca8d1f85aa34b))
* enforce strict episode matching with air-date indexing ([d74d2ee](https://github.com/cubbieblue16/comet/commit/d74d2ee8745839fe8f577089fdd4833601938cc1))
* enforce strict episode matching with air-date indexing ([aebaf73](https://github.com/cubbieblue16/comet/commit/aebaf7390d40eb806d65751ca678f9855d1122ed))
* enhance database functionality with new predicates and JSON handling ([21ebac8](https://github.com/cubbieblue16/comet/commit/21ebac83524923e754726d91770b9c33503cc7d1))
* enhance memory management with mimalloc support ([54f3f06](https://github.com/cubbieblue16/comet/commit/54f3f062e71b2ec0e2d4fd46fe2a84888696cfa7))
* enhance URL handling in scrapers with context-aware parsing ([8546296](https://github.com/cubbieblue16/comet/commit/8546296d3394df2a8c84679dc1bb6513002567c9))
* improve periodic memory trimming with enhanced error handling ([5af2dbe](https://github.com/cubbieblue16/comet/commit/5af2dbe64f1a6a2384f1f105dff1ff9a28381f5c))
* integrate date resolver into debrid availability filtering ([5b1d38a](https://github.com/cubbieblue16/comet/commit/5b1d38a7968cb0c098bdd0584ec26b12ae7bf9f0))
* integrate date resolver into download link file scoring ([fc4ed9a](https://github.com/cubbieblue16/comet/commit/fc4ed9a94b639b2743230b77840bb8b87b7a5ffc))
* introduce common Docker build workflow and streamline existing workflows ([ca28fb8](https://github.com/cubbieblue16/comet/commit/ca28fb8e49bfd853d806c4c2bf5e9540d7b7b2da))
* log memory trim interval in startup information ([e7288c1](https://github.com/cubbieblue16/comet/commit/e7288c1ab4d0768ee02096ad4acbbc6dc8dbdecb))
* resolve date-based episodes at torrent cache ingestion ([cb4a068](https://github.com/cubbieblue16/comet/commit/cb4a068be63a4045db8d2dacc10d3d6125598a10))
* switch to the Rust filename parser ([d12f80c](https://github.com/cubbieblue16/comet/commit/d12f80cf9dea7b391aceed6ee012122410522e52))
* TMDB_TO_IMDB_OVERRIDES env map for TMDB items missing IMDB links ([79fad4e](https://github.com/cubbieblue16/comet/commit/79fad4e1e760f3084977c3781f3791ecef386207))
* update TPR link ([bc012df](https://github.com/cubbieblue16/comet/commit/bc012dfbfd69e67fc8783e43c75b4a51bff65f91))


### Bug Fixes

* add +/- 1 day tolerance for date-based episode matching ([8d689e9](https://github.com/cubbieblue16/comet/commit/8d689e9f2aca802bf7fc09e38bbf0792efe8f2ba))
* add cachetools to project dependencies ([645be55](https://github.com/cubbieblue16/comet/commit/645be5511bdbb13284cf14ab14dd8367df9b2b08))
* add missing API key header in Trakt aliases request ([3db3769](https://github.com/cubbieblue16/comet/commit/3db37694df23054e5206254dfebdea6f680114de))
* add PERMISSIVE_RANKING and PERMISSIVE_EPISODE_MATCHING env vars ([dc0ad07](https://github.com/cubbieblue16/comet/commit/dc0ad0730c0d7d1d0f453da6533a31b2114a6e31))
* add required Trakt API headers to alias fetching ([0d581ab](https://github.com/cubbieblue16/comet/commit/0d581abe9292a1f9a3c2c11e52ddfa347c98efdd))
* advertise tmdb in manifest idPrefixes so Stremio actually sends requests ([dc7f34c](https://github.com/cubbieblue16/comet/commit/dc7f34ccfe81741e460ef7f1e1312773a9c4d82a))
* apply reboot filter to cached torrents from CometNet ([f90cd12](https://github.com/cubbieblue16/comet/commit/f90cd12f59b17f0b41c2e424e1180b34e805c858))
* correct bandwidth statistics update logic ([d1e37bb](https://github.com/cubbieblue16/comet/commit/d1e37bb81e7f7fcea24cce36de896b231da3e3b7))
* disable season fallback in hot path, enable resolver for movies ([2997903](https://github.com/cubbieblue16/comet/commit/29979032bfd27cf4e390b5e116f6daeb9ec69dd0))
* don't use DOMContentLoaded as it isn't needed ([a30637c](https://github.com/cubbieblue16/comet/commit/a30637c6025f11f2ec3b98b2e6732fd342f125aa))
* don't use DOMContentLoaded as it isn't needed ([15d405e](https://github.com/cubbieblue16/comet/commit/15d405efdff7627ea710910672f866eaf677096a))
* enforce media ID requirement for torrent operations ([44f423d](https://github.com/cubbieblue16/comet/commit/44f423d4be229b487de1863ac903da2232f997ee))
* enforce non-empty imdb_id requirement in torrent metadata ([386b4dd](https://github.com/cubbieblue16/comet/commit/386b4dd1ad75badd43031c73cfc445aa4f37f168))
* enhance error logging in info hash normalization ([26ecdf2](https://github.com/cubbieblue16/comet/commit/26ecdf2310c36afaf10dd15c41c20721dfc0d7ab))
* exclude miniupnpc version 2.3.3 and update to 2.3.2 ([a168860](https://github.com/cubbieblue16/comet/commit/a1688600238666e812e8f597d17aa934369ddd1e))
* filter out old physical media torrents for rebooted/revived series ([74a8dfb](https://github.com/cubbieblue16/comet/commit/74a8dfbf595383f848f7bcc00c68a6eb9712e2f3))
* handle missing video size in torrent behavior hints ([bab5445](https://github.com/cubbieblue16/comet/commit/bab5445a785c46bd4ad1e67198af088692d0a2fd))
* harden date resolver implementation per code review ([23c04c8](https://github.com/cubbieblue16/comet/commit/23c04c82946771577e16461b3904a66d74103e38))
* import gunicorn in run_with_gunicorn function to fix windows issues ([7f89f7a](https://github.com/cubbieblue16/comet/commit/7f89f7a1ee2c09dcfc8f0dcb2799de060ffd365b))
* import gunicorn in run_with_gunicorn function to fix windows issues ([cecb61e](https://github.com/cubbieblue16/comet/commit/cecb61e8d85c5387f4ae6a46a4aec0831dd7e17c))
* improve title matching for WWE shows and make Trakt API key configurable ([4c165ad](https://github.com/cubbieblue16/comet/commit/4c165ad114c37debe5f4c6ddeec4edf477789e37))
* optimize search metrics query in admin API ([610f7e7](https://github.com/cubbieblue16/comet/commit/610f7e7fb9fcc0be7ecd3e2cc9cd31c49cb9568d))
* patch 18 bugs across scrapers, CometNet, and services ([9c355c8](https://github.com/cubbieblue16/comet/commit/9c355c87770c6b2c4deaf213a279e0a7dccfc851))
* permissive filtering pipeline and harden Torbox scraper ([abbe93b](https://github.com/cubbieblue16/comet/commit/abbe93b6fcf95caa2019071f64a28e8e9928f4d3))
* **playback:** Fix name_query not being parsed ([798bf80](https://github.com/cubbieblue16/comet/commit/798bf8002c6f98646a4986c9cef919b515aa93b6))
* **playback:** Fix name_query not being parsed ([458be8c](https://github.com/cubbieblue16/comet/commit/458be8c857cc9f5716aab87f26378090431fa6f0))
* **playback:** Validate and strip torrent name and video name parameters ([2476bb0](https://github.com/cubbieblue16/comet/commit/2476bb02de86c96d6d606fa70d8cd3083e6218e3))
* prevent auto-scrolling when new logs are appended if not at the bottom ([5457db0](https://github.com/cubbieblue16/comet/commit/5457db0143fa19cd6056d8531f0fe20860cb10e1))
* prevent auto-scrolling when new logs are appended if not at the bottom ([19bf51f](https://github.com/cubbieblue16/comet/commit/19bf51f64d981d07c37a94811fcf0f687ff10c37))
* relax strict episode rejection for date-based shows ([da44d9b](https://github.com/cubbieblue16/comet/commit/da44d9b7666793e3625f2aa03042fb38df000f4f))
* relax strict episode rejection on cached path too ([ac02182](https://github.com/cubbieblue16/comet/commit/ac0218237943d61581dcee3600e8afa16a093cb4))
* remove Docker Hub push from CI, use GHCR only ([b3f03e4](https://github.com/cubbieblue16/comet/commit/b3f03e4667f5885d27a5ae8fa21b0c9a338da8b3))
* remove upper year bound for movies to match series behavior ([e01d951](https://github.com/cubbieblue16/comet/commit/e01d9513e1aace7fc176e070607baccc81488aa7))
* require expected-title digits to appear in torrent title ([4f85a0e](https://github.com/cubbieblue16/comet/commit/4f85a0e6fff2296b95be14f65ed209ddea406a16))
* require year in filename for brand-new series (reboot protection) ([59573ae](https://github.com/cubbieblue16/comet/commit/59573ae365371c69c729a6be705258e4ad1e34bb))
* simplify metadata_updated_at assignment in SQL queries ([952217e](https://github.com/cubbieblue16/comet/commit/952217ece69d76377054e79d85d43a5c00a2724d))
* simplify metadata_updated_at assignment in SQL queries ([6298755](https://github.com/cubbieblue16/comet/commit/6298755ea0382b778551020924231fd723ebd354))
* update last_seen_at timestamp in background scraper ([b1fbab5](https://github.com/cubbieblue16/comet/commit/b1fbab57f1fbde799d0acb573f4aabacac72fbfa))
* update media ID matching logic in background scraper ([52dca3b](https://github.com/cubbieblue16/comet/commit/52dca3b1f0c02d39560693335a8b0452894c759b))
* update miniupnpc dependency and Dockerfile cache configuration ([c31bfe1](https://github.com/cubbieblue16/comet/commit/c31bfe16707c46354b420dd8cdbc6a4e48ecad52))
* update search query timestamps in admin API metrics ([44b7432](https://github.com/cubbieblue16/comet/commit/44b7432f018f310a5448bca04c70b88ba353e653))
